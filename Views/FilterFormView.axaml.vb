...
Namespace Views
    ...
    ''' <summary>Formularkern von „Filter anwenden" (Quelle/Vorgabe/Stärke) - vom Einzeldialog UND
    ''' vom „Exportieren nach"-Dialog eingebettet, damit beide exakt dieselben Optionen zeigen.</summary>
    Public Class FilterFormView
