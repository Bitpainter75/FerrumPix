    ...
    Public NotInheritable Class AiModelService
        ...
        Public Shared ReadOnly Property KnownEntries As IReadOnlyList(Of ModelEntry) =
            New List(Of ModelEntry) From {
                ...
                New ModelEntry With {.Key = "drunet",
                                        .FileName = "drunet-v1.onnx", .Group = "Entrauschen dosiert",
                                        .Purpose = "Rauschen entfernen, Stärke geht ins Modell", .Bytes = 130589249,
                                        .GpuAllowed = True,
                                        .Sha256 = "844a0cb67140860d3b651523eb41816dc106b2f8239425a31e0fd35a98472b48"},
