    ...
    Public NotInheritable Class AiModelService
        ...
        Public Shared ReadOnly Property KnownEntries As IReadOnlyList(Of ModelEntry) =
            New List(Of ModelEntry) From {
                ...
                New ModelEntry With {.Key = "ram-plus",
                                        .FileName = "ram-plus-int8-v1.onnx", .Group = "Automatische Stichwörter",
                                        .Purpose = "Bildinhalte erkennen (INT8, 833 MB)", .Bytes = 872789856,
                                        .Herkunft = "https://huggingface.co/anakhiu/ram-plus-onnx-int8/resolve/f5226bd4d7667a08fe475b95dcf0be66c86aa4fb/ram_plus_int8.onnx",
                                        .Sha256 = "44836da6724dcbdd7446632599c190426af96bd47d4457d47d876b019e10f8bd"},
                New ModelEntry With {.Key = "ram-plus-tags",
                                        .FileName = "ram-plus-tags-v1.txt", .Group = "Automatische Stichwörter",
                                        .Purpose = "Stichwortvokabular", .Bytes = 41904,
                                        .Herkunft = "https://huggingface.co/anakhiu/ram-plus-onnx-int8/resolve/f5226bd4d7667a08fe475b95dcf0be66c86aa4fb/ram_tag_list.txt",
                                        .Sha256 = "5d96d2f7225527480ad773aaac76b6e5c08a18adf6eae9ca7d2ab923d5e7bd8b"},
                New ModelEntry With {.Key = "ram-plus-thresholds",
                                        .FileName = "ram-plus-thresholds-v1.txt", .Group = "Automatische Stichwörter",
                                        .Purpose = "Modellspezifische Mindestwerte", .Bytes = 22016,
                                        .Herkunft = "https://huggingface.co/anakhiu/ram-plus-onnx-int8/resolve/f5226bd4d7667a08fe475b95dcf0be66c86aa4fb/ram_tag_list_threshold.txt",
                                        .Sha256 = "b6f81d0de1bc7f9c251af512c413eae976c77dbfbadf700d4e3d90510f4c6447"},
